...
SOURCES=$(DUKTAPE_PATH)/src/duktape.c $(DUKTAPE_PATH)/extras/console/duk_console.c $(DUKTAPE_PATH)/extras/module-node/duk_module_node.c duk_poll.c base64.c pynogil.c main.c
OBJECTS=$(SOURCES:.c=.o)
EXECUTABLE=pynogil
